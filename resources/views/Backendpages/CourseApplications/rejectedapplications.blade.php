...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-9">
                    <h3 class="m-0" style="color: black;">Rejected Applications</h3>
                </div><!-- /.col -->
                <div class="col-sm-3">
    ...
    <script>
        ...
        function courseList() {
            ...
            $.ajax({
                type: "GET",
                url: "/Rejected/Applications/List",
                dataType: "json",
                success: function(response) {
                    let counter = 1;
                    $.each(response.data, function(index, item) {
                        let status = item.Application_status;
                        let rejected_on = `${formatDate(item.Application_Updated)}`;


                        let actions = `
                    <button class="btn btn-danger btn-sm pending-btn mx-1" data-id="${item.id}" title="To Pending">
                    <i class="fa-solid fa-rotate-left"></i>
                    </button>
                    <button class="btn btn-success btn-sm approve-btn mx-1" data-id="${item.id}" title="To Approve">
