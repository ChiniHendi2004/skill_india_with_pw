...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-9">
                    <h3 class="m-0" style="color: black;">Approved Applications</h3>
                </div><!-- /.col -->
                <div class="col-sm-3">
    ...
    <script>
        ...
        function courseList() {
            ...
            $.ajax({
                type: "GET",
                url: "/Approved/Applications/List",
                dataType: "json",
                success: function(response) {
                    let counter = 1;
                    $.each(response.data, function(index, item) {
                        let status = item.Application_status;
                        let approved_at = item.updated_at;

                        let actions = `
                    <button class="btn btn-success btn-sm pending-btn mx-1" data-id="${item.id}" title="Pending">
